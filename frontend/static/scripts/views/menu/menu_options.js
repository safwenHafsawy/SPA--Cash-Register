const regularMenu = `
<div id="menu">
    <h3 id="menu_header">Please Select a category</h3>
    <div id="cards">
      <div id="drinks" class="card_menu 1" data-menu>
    ...
    <div id="Food" class="card_menu 2" data-menu>
    ...
    <div id="Divers" class="card_menu 3" data-menu>
    ...
    <div id="food__menu">
        ...
        <div id="food__cards">
            <div class="food__card">
                <h1 class="card__header">Latte</h1>
...
const drinksMenu = `drinks Menu`;

const diversMenu = `some menu`;

export default [regularMenu, foodMenu, drinksMenu, diversMenu];
